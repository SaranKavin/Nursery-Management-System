...
if (isset($_GET['id'])) {
    ...
    $sql_fetch_product = "SELECT price_per_kg FROM plants WHERE id = $productId";
    ...
    if ($result_fetch_product->num_rows > 0) {
        ...
        $sql_check_quantity = "SELECT total_quantity FROM plants WHERE id = $productId";
        ...
        if ($result_check_quantity->num_rows > 0) {
            ...
            if ($quantity > 0) {
                ...
                $sql_update_quantity = "UPDATE plants SET total_quantity = total_quantity - 1, 
